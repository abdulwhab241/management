...
{{-- <link href="{{ URL::asset('/assets/dist/fonts/fonts-fa.css') }}" rel="stylesheet"> --}}
<link rel="stylesheet" href="/dist/fonts/fonts-fa.css">
{{-- <link href="{{ URL::asset('/assets/dist/css/bootstrap-rtl.min.css') }}" rel="stylesheet"> --}}

{{-- <link href="{{ URL::asset('/assets/dist/css/rtl.css') }}" rel="stylesheet"> --}}
...
<script rel="stylesheet" src="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.8.7/chosen.min.css"></script> --}}
