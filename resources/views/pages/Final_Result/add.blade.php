...
<div class="row">
    ...
    <div class="col-md-6">
        <label>رقـماُ</label>
        <input type="number" value="{{ old('F_Number') }}" name="F_Number" class="form-control">
        @error('F_Number')
        <div class=" alert-danger">
        <span style="text-align: center; font-weight: bold;"><h3 style="text-align: center font-weight: bold;"> {{ $message }}</h3></span>
        </div>
    ...
    <div class="col-md-6">
        <label>كتـابـة</label>
        <input type="text" value="{{ old('F_Write') }}" name="F_Write" class="form-control">
        @error('F_Write')
        <div class=" alert-danger">
        <span style="text-align: center; font-weight: bold;"><h3 style="text-align: center font-weight: bold;"> {{ $message }}</h3></span>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <label>رقـماُ</label>
            <input type="number" value="{{ old('S_Number') }}" name="S_Number" class="form-control">
            @error('S_Number')
            <div class=" alert-danger">
            <span style="text-align: center; font-weight: bold;"><h3 style="text-align: center font-weight: bold;"> {{ $message }}</h3></span>
            </div>
        ...
        <div class="col-md-4">
            <label>كتـابـة</label>
            <input type="text" value="{{ old('S_Write') }}" name="S_Write" class="form-control">
            @error('S_Write')
            <div class=" alert-danger">
            <span style="text-align: center; font-weight: bold;"><h3 style="text-align: center font-weight: bold;"> {{ $message }}</h3></span>
            </div>
