...
<!-- breadcrumb -->
@section('PageTitle')
تعديـل رسـوم الطالـب : <label style="color: red">{{$receipt_student->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="2">{{$receipt_student->description}}</textarea>
                                    </div>
                                </div>
                            ...
                            style="padding:5px; margin: 5px;" type="submit">تعديـل البيانـات</button>
                        </form>
