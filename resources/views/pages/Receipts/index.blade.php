...
<div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
        <div class="card-body">
            <a href="{{route('receipt_students.create')}}" class="btn btn-outline-success btn-sm" role="button"
            style="margin: 5px; padding: 5px;" aria-pressed="true">اضافة سنـد تسديـد جديـد</a><br><br>
