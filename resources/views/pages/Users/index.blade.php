...
<li class="active">قائمة الـمستخـدميـن</li>
</ol>
</section>
...
<a href="{{route('Users.create')}}" class="btn btn-success btn-flat" role="button" aria-pressed="true">اضافة مستـخـم جـديـد</a>
<br><br>
<div class="box-tools">
    ...
    <div class="modal-dialog modal-danger" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">حـذف مستخدم</h5>
