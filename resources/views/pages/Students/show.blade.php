...
<div class="box">
    <div class="col-md-12">
        ...
        <ul class="nav nav-tabs">
            <li class="btn-info"><a href="#tab_1" data-toggle="tab" style="font-weight:bolder; font-color:white;">معلـومـات الطـالـب</a></li>
        ...
        <div class="tab-content"><br>
            ...
            <p>sfspojfoihoiuhuibiugvyivpyucvtuvuhjbkn</p>
            </div><!-- /.tab-pane -->
