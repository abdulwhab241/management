    ...
    <div class="modal-dialog modal-danger">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">حـذف صـورة</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Delete_attachment')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">هل انت متأكد من حذف الصورة ؟</h5>
